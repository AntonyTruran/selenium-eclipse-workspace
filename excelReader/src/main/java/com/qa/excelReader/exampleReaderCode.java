...
public class exampleReaderCode {

	@Parameters
	public static Collection<Object[]> data() throws IOException {
		Constants constant = new Constants();
		FileInputStream file = new FileInputStream(constant.getFileLocation());
...
//		Reading
	...
	public exampleReaderCode(String username, String password, String expected, int rowNum) {
